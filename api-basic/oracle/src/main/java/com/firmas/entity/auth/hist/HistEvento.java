package com.firmas.entity.auth.hist;
...
import com.firmas.entity.auth.TypeOperacionAuth;
import com.firmas.util.CadenaUtil;
...
public class HistEvento {
  ...
  @Column(columnDefinition = "varchar(24) default 'LOGIN'")
  @Enumerated(value = EnumType.STRING)
